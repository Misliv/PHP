...
function register(){
    ...
    if (empty($username)) {
        array_push($errors, "Gebruikersnaam vereist");
    }
    if (empty($password_1)) {
        array_push($errors, "Wachtwoord vereist");
    }
    if ($password_1 != $password_2) {
        array_push($errors, "De wachtwoorden passen niet bijelkaar");
    }
    ...
    if (count($errors) == 0) {
        ...
        if (isset($_POST['user_type'])) {
            ...
            $_SESSION['success']  = "Nieuwe gebruiker aangemaakt";
